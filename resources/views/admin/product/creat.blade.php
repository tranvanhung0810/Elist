  ...
  <div class="form-row">
    <div class="form-group col-lg-7 @error('products_name') has-error  @enderror">
        ...
        @if(Session::has('success'))
          ...
          @endif 
      <input type="text" class="form-control" name="products_name"   placeholder="Nhập Tên Sản Phẩm">
     ...
     <div class="form-group col-lg-7 @error('price') has-error  @enderror">
      ...
      <input type="text" class="form-control" name="price" value=""  placeholder="Nhập Gía Sản Phẩm">
      @error('price')
      <small class="help-block">{{$message}}</small>
      @enderror
    </div>
      ...
      <input type="text" class="form-control" name="sale_price" value=""  placeholder="Nhập Gía Khuyến Mãi">
      @error('sale_price')
      <small class="help-block">{{$message}}</small>
      @enderror
    </div>
      ...
      <input type="text" class="form-control" name="brand" value=""  placeholder="Nhập Hãng">
      @error('brand')
      <small class="help-block">{{$message}}</small>
      @enderror
    </div>
      ...
      <input type="text" class="form-control" name="ordering" value=""  placeholder="Nhập Thứ Tự">
      @error('ordering')
      <small class="help-block">{{$message}}</small>
      @enderror
    </div>
...
<input type="text" name="image_list" id="image_list">
      ...
      <textarea id="content" name="products_descripttion" class="form-control" rows="3"></textarea> 
...
<div class="checkbox">
 ...
 {{$siz->sizes_name}}
  ...
  @endforeach
     ...
     <div class="radio">
     	<label>
     		<input type="radio" name="products_status" id="input" value="1" checked="checked">
     		Hiện
     	</label>
     	<label>
     		<input type="radio" name="products_status" id="input" value="0">
     		Ẩn
